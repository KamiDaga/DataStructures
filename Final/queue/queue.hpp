...
public:
  ...
  // Copy assignment
  void operator=(const Queue<Data>&) = delete; // Copy assignment of abstract types should not be possible.

  // Move assignment
  void operator=(Queue<Data>&&) = delete; // Move assignment of abstract types should not be possible.

  // Comparison operators
  bool operator==(const Queue<Data>&)const = delete; // Comparison of abstract types might not be possible.
  bool operator!=(const Queue<Data>&)const = delete; // Comparison of abstract types might not be possible.
